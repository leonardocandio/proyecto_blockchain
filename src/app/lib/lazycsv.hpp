//
// Created by Leonardo Candio on 22/02/23.
//

#ifndef PROYECTO_BLOCKCHAIN_LAZYCSV_HPP
#define PROYECTO_BLOCKCHAIN_LAZYCSV_HPP
#pragma once
    ...
    public:
        ...
        public:
            ...
            cell(const char *begin, const char *end)
                : begin_(escape_leading_quote(begin, end)), end_(escape_trailing_quote(begin, end)) {
            }
...
#endif//PROYECTO_BLOCKCHAIN_LAZYCSV_HPP
